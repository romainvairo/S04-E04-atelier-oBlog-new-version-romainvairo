...
$dataArticlesList = [
    1 => new Article(
        ...
        3, // Id/index de l'auteur
        '2017-07-13',
        4 // Id/index de la catégorie
    ),
    2 => new Article(
